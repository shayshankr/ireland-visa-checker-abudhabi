...
st.set_page_config(
    page_title="Ireland Visa Decision Checker – Abu Dhabi",
    page_icon="🇮🇪",
    layout="centered",
)
...
def fetch_data() -> tuple[pd.DataFrame | None, list[str] | None]:
    ...
    for link in soup.find_all("a"):
        ...
        if href.endswith(".pdf") and "Abu Dhabi Visa" in text:
...
st.caption("Abu Dhabi Embassy · Data sourced from ireland.ie")
